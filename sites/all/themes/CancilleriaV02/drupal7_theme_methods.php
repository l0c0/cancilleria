...
$art_style = '';
$art_head = '';
function CancilleriaV02_process_html(&$variables) {
...
function CancilleriaV02_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function CancilleriaV02_button($variables) {
 ...
 */
function CancilleriaV02_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function CancilleriaV02_menu_local_task($variables) {
 ...
 */
function CancilleriaV02_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function CancilleriaV02_node_preview($variables) {
  $node = $variables['node'];
...
*/
function CancilleriaV02_form_alter(&$form, &$form_state, $form_id) {
...
function CancilleriaV02_form_element_label($variables) {
...
function CancilleriaV02_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
...
function CancilleriaV02_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
  ...
  if ($pager_total[$element] > 1) {
    ...
    return '<h2 class="element-invisible">' . t('Pages') . '</h2>' . art_item_list(array(
      'items' => $items,
      'attributes' => array('class' => array('Cancilleria_pager')),
    ));
  }
}
