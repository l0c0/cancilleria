...
<header class="Cancilleria_header"><?php if (!empty($art_header)) { echo render($art_header); } ?>
...
<div class="Cancilleria_layout-wrapper">
...
<div class="Cancilleria_layout-cell Cancilleria_sidebar1"><?php echo render($vnavigation_left); ?>
<?php echo render($art_sidebar_left); ?>
</div><?php endif; ?>
                        <div class="Cancilleria_layout-cell Cancilleria_content"><?php if (!empty($banner2)) { echo '<div id="banner2">'.render($banner2).'</div>'; } ?>
...
<article class="Cancilleria_post Cancilleria_article">
                ...
                <div class="Cancilleria_postcontent"><?php print render($title_prefix); ?>
...
<footer class="Cancilleria_footer"><?php
